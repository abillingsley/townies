...
// import SetApplicationContext from "../prerequisites/SetApplicationContext";
...
export default class ApplicationAuthorizedRoute implements RouteAdditionalConfigurationOptions {
  ...
  public auth: false | string | AuthOptions = false;
  ...
  public pre: RoutePrerequisitesArray = []; // SetApplicationContext;
}
